...
if __name__=='__main__':
    ...
    """
    weight_path = "/home/wma/yolov4-tiny-pytorch-master/logs/best_epoch_weights.pth"  # 需要配置的变量: 训练好的模型路径
    folded_weight_path = "/home/wma/yolov4-tiny-pytorch-master/HLS_pj/folded_weight" # 导出权重的存储路径
